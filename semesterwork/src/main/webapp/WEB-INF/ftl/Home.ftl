        ...
        <div class="home__holder">
            <div class="home__intro">
                <div class="intro__video">
                    <video src="/static/video/videoplayback.webm" autoplay muted loop></video>
                </div>
            ...
            <div class="home__element">
                <div class="element__img">
                    <img src="/static/img/rocket_spacex.jpeg" alt="photo_earth">
                </div>
            ...
            <div class="home__element">
                <div class="element__img">
                    <img src="/static/img/earth_photo.png" alt="photo_earth">
                </div>
                <div class="element__text_holder">
                    <div class="text_holder__text">
